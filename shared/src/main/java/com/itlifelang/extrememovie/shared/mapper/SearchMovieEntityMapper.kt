...
import com.itlifelang.extrememovie.shared.data.db.SearchMovieEntity

fun SearchMovieEntity.mapToModel(): MovieModel = MovieModel(
    id = id,
    imdbId = imdbId,
    adult = adult,
...
fun MovieModel.mapToEntity(insertTime: Long): SearchMovieEntity = SearchMovieEntity(
    id = id ?: 0,
    imdbId = imdbId,
    adult = adult,
    backdropPath = backdropPath,

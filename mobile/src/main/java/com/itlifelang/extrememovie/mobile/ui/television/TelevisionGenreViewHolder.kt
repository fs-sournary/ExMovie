...
class TelevisionGenreViewHolder(
    ...
    fun bindData(genre: Genre) {
        ...
        binding.apply {
            ...
            lifecycleOwner = this@TelevisionGenreViewHolder.lifecycleOwner
    ...
    companion object {
        ...
        ): TelevisionGenreViewHolder {
            val inflater = LayoutInflater.from(parent.context)
            val binding = ItemGenreBinding.inflate(inflater, parent, false)
            return TelevisionGenreViewHolder(binding, lifecycleOwner, selectedGenre, click)
        }
    }
}
